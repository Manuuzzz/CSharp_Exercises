...
namespace _10_Arraysb
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int sum = 0,  counter = 0, intValue = 0;
            int?[] myIntArray = new int?[7] { 5, intValue, 9, 10, null, 2, 99 }; //question mark means that a null value is possible in the array
            ...
            WriteLine($"{counter} total integers, {counter} integers with a" + $"value other than 0 or null have a sum value of {sum}");
            ReadLine();
        }
    }
}
